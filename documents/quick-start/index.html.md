...
<document-group id="getting-started" class="row row-cols-1 row-cols-md-3 g-4" root-path="quick-start" render-glob="**/*.html" skip-glob="**/index.html" sort-by="step" template="doc-group-list.html.ejs"></document-group>
